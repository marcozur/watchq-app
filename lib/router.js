...
var getFunctionThatAppendsAStringToWhateverWasPassedIn = function(string) {
  return function(stringToAppend) {
    return string + stringToAppend;
  };
};

var template = getFunctionThatAppendsAStringToWhateverWasPassedIn("hallo ");
